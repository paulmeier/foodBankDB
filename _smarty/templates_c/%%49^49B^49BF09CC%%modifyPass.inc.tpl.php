<?php /* Smarty version 2.6.18, created on 2007-12-12 21:30:44
         compiled from modifyPass.inc.tpl */ ?>
<form name="usersForm" action="" method="POST" autocomplete="off">
<br />
<br />
  <div class="style3" id="Bck"><?php echo $this->_tpl_vars['changed']; ?>
</div>
  <br />
...
$this->_sections['idx']['loop'] = is_array($_loop=$this->_tpl_vars['adminData']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
===========Administrator=========
<tr><td>Username:</td><td><INPUT name="Adminusername" value="<?php echo $this->_tpl_vars['adminData'][$this->_sections['idx']['index']]['USERNAME']; ?>
"/></td></tr>
<tr><td>Password:</td><td><INPUT name="Adminpassword" value="<?php echo $this->_tpl_vars['adminData'][$this->_sections['idx']['index']]['PASSWORD']; ?>
"/></td></tr>
<tr><td></td></tr>
<?php endfor; endif; ?>
</table>
...
?>
===========Organization===========
<tr><td>Username:</td><td><INPUT name="Orgusername" value="<?php echo $this->_tpl_vars['orgData'][$this->_sections['idx']['index']]['USERNAME']; ?>
"/></td></tr>
<tr><td>Password:</td><td><INPUT name="Orgpassword" value="<?php echo $this->_tpl_vars['orgData'][$this->_sections['idx']['index']]['PASSWORD']; ?>
"/></td></tr>
<tr><td></td></tr>
<?php endfor; endif; ?>
</table>
...
?>
==============Person==============
<tr><td>Username:</td><td><INPUT name="Personusername" value="<?php echo $this->_tpl_vars['personData'][$this->_sections['idx']['index']]['USERNAME']; ?>
"/></td></tr>
<tr><td>Password:</td><td><INPUT name="Personpassword" value="<?php echo $this->_tpl_vars['personData'][$this->_sections['idx']['index']]['PASSWORD']; ?>
"/></td></tr>
<tr><td></td></tr>
<?php endfor; endif; ?>
</table>
